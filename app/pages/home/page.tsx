...
export default function Login() {
  ...
  return (
    <div>
      ...
      <div className='mt-2 p-4 sm:ml-4 lg:ml-16 pb-8 flex space-x-10 max-w-full overflow-x-scroll hide-scrollbar'>
        <div className='w-[300px] sm:w-[384px]'>
          <Card 
            image='/course_3.svg' 
            time='01 hr 02 mins' 
            course_name='Figma UI UX Design...' 
            discription='Use Figma to get a job in UI Design, User Interface, User Experience design.'
            rating='4.3' 
            no_rating='16,325' 
            name='Jane Cooper' 
            dp='/dp3.svg' 
        ...
        <div className='w-[300px] sm:w-[384px]'>
          <Card 
            image='/course_2.svg' 
            time='06 hr 03 mins' 
            course_name='Learn With Shoaib' 
            discription='Design Web Sites and Mobile Apps that Your Users Love and Return to Again.'
            rating='3.9' 
            no_rating='832' 
            name='Jenny Wilson' 
            dp='/dp2.svg' 
      ...
      <div className='flex justify-center mb-4'>
        <button className='bg-black w-48 h-8 rounded-md text-white'>
